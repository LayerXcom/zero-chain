...
use serde::Serialize;
use srml_support::{
    decl_event, decl_module, decl_storage, for_each_tuple, storage, Parameter, StorageMap,
    StorageValue,
};
use substrate_primitives::storage::well_known_keys;
use zprimitives::{IntoXY, SigVk};
...
pub trait Trait: 'static + Eq + Clone {
    ...
    type Header: Parameter
        + traits::Header<Number = Self::BlockNumber, Hash = Self::Hash, Digest = Self::Digest>;
