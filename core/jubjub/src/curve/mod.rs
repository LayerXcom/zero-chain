...
use pairing::{Engine, Field, PrimeField, SqrtField};
...
impl JubjubBls12 {
    pub fn new() -> Self {
        ...
        // Create the bases for other parts of the protocol
        {
            ...
            fixed_base_generators[FixedGenerators::Diversifier as usize] = find_group_hash(
                b"r",
                constants::PEDERSEN_HASH_GENERATORS_PERSONALIZATION,
                &tmp_params,
            );

            fixed_base_generators[FixedGenerators::ElGamal as usize] = find_group_hash(
                &[],
